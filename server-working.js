...
// Try to load full dataset from JSON file (e.g. /app/data/kredit_data.json in Docker)
let records = [];
try {
  const dataPath = process.env.KREDIT_DATA_PATH || path.join(__dirname, 'data', 'kredit_data.json');
  ...
  if (Array.isArray(parsed)) {
    ...
    console.error(`Data file at ${dataPath} does not contain an array, falling back to demo data.`);
  }
} catch (err) {
